...
For artifact 3, I concentrated on improving the AnimalCrud.py script, which was first created for the CS340 class. This Python program serves as the backend for Grazioso Salvare Animal Shelter's web dashboard, allowing for efficient data handling and display. During the upgrade phase, I focused my efforts on improving data retrieval and processing capabilities by leveraging sophisticated MongoDB features. This involved putting in place advanced aggregation pipelines and indexing algorithms to better handle massive datasets, guaranteeing strong data management, and improving dashboard performance. Working on this project expanded my knowledge of database administration and algorithm optimization, which are critical abilities for real-world software development issues.
...
I concentrated on improving the AnimalCrud.py script, which was first created for the CS340 class. This Python program serves as the backend for Grazioso Salvare Animal Shelter's web dashboard, allowing for efficient data handling and display. During the upgrade phase, I focused my efforts on improving data retrieval and processing capabilities by leveraging sophisticated MongoDB features. This involved putting in place advanced aggregation pipelines and indexing algorithms to better handle massive datasets, guaranteeing strong data management, and improving dashboard performance. Working on this project expanded my knowledge of database administration and algorithm optimization, which are critical abilities for real-world software development issues.
